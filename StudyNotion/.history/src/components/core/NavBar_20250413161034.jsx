              ...
              <li key={index}>
                {link.title === "Catalog" ? (
                  <div className="relative flex items-center gap-2 group">
                    ...
                    <div className="invisible absolute left-[50%] top-[50%] flex flex-col rounded-r-md bg-richblack-5 p-4 text-richblack-700 opacity-0 transition-all duration-200 group-hover:visible group-hover:opacity-100 lg:w-[300px]">
