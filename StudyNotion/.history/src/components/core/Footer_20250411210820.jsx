...
const Footer = () => {
  return (
    <footer className="bg-richblack-800 text-white p-14 mt-10 flex flex-row">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-">
        {/* Company Section */}
