    ...
    <div>
      <div className="flex flex-row gap-20 items-center ">
        ...
        <div className="relative shadow-blue-200">
            ...
            <div className="absolute bg-caribbeangreen-700 flex flex-row text-white uppercase py- left-[50%] translate-x-[-50%] translate-y-[-50%]">
                ...
                <p className="text-caribbeangreen-300 text-xl">types of course</p>
                </div>
            </div>
        </div>
      </div>
