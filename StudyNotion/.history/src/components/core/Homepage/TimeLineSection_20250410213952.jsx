                ...
                return (
                  <div className="flex flex-row gap-5" key={index}>
                    <div className="w-[50px] h-[50px] bg-white flex items-center">
                      <img className='bg-white shadow-lg rounded-full p-3 hidden lg:block  h-14 border-dotted border-r border-richblack-100 bg-richblack-400/0 w-[26px]' src={element.Logo} alt="" />
