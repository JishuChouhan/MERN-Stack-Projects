    ...
    <div>
      <div className="flex flex-row gap-20 items-center ">
        ...
        <div className="relative shadow-blue-200">
            <img className="h-[350px] w-[600px] shadow-2xl shadow-brown-900 object-cover rounded-lg absolute -top-4 -left-4 bg-purple-300 blur-2xl opacity-70" src={timeLineImg} alt="" />
        </div>
      </div>
    </div>
  );
