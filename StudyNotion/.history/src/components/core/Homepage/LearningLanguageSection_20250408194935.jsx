    ...
    <div>
      <div className="flex flex-row gap-20 items-center ">
        ...
        <div className="relative shadow-blue-200">
            ...
            <div className="absolute bg-caribbeangreen-700 flex flex-row text-white uppercase left-[50%] translate-x-[-50%] translate-y-[-50%]">
                <div className="flex flex-row gap-5 items-center border-r border-caribbeangreen-400 px-8">
